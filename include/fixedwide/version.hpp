...
#define FIXEDWIDE_VERSION_PRERELEASE "alpha.2"
#define FIXEDWIDE_VERSION_STRING "0.5.0-alpha.2"
...
inline constexpr const char* version_prerelease = "alpha.2";
inline constexpr const char* version_string = "0.5.0-alpha.2";
}
