...
|---|---|---|---:|---:|---:|---|
| fixedwide | `Fixed64<4>` | add | 0.406 | 0.403 | 0.408 | yes |
| fixedwide | `Fixed64<4>` | mul | 1.298 | 1.289 | 1.524 | yes |
| fixedwide | `Fixed64<4>` | div | 1.430 | 1.422 | 1.442 | yes |
| fixedwide | `Fixed64<4>` | parse | 9.334 | 9.270 | 9.350 | yes |
| fixedwide | `Fixed64<4>` | format_fixed | 10.948 | 10.883 | 10.955 | yes |
| decimal_for_cpp | `decimal<4,half_even>` | add | 0.283 | 0.283 | 0.287 | no |
| decimal_for_cpp | `decimal<4,half_even>` | mul | 6.388 | 6.335 | 6.461 | no |
| decimal_for_cpp | `decimal<4,half_even>` | div | 6.373 | 6.345 | 6.583 | no |
| decimal_for_cpp | `decimal<4,half_even>` | parse | 75.296 | 74.906 | 76.461 | no |
| decimal_for_cpp | `decimal<4,half_even>` | format_fixed | 106.498 | 106.213 | 107.453 | no |
| cnl | `scaled_integer<int64,power<-4,10>>` | add | 0.288 | 0.287 | 0.290 | no |
| cnl | `scaled_integer<int64,power<-4,10>>` | mul | 0.578 | 0.571 | 0.584 | no |
| cnl | `scaled_integer<int64,power<-4,10>>` | div_same_type | 1.219 | 1.209 | 1.227 | no |
...
| library | type | operation | median ns/op | min ns | p95 ns | checked |
|---|---|---|---:|---:|---:|---|
| fixedwide | `Fixed64<12>` | add | 0.425 | 0.423 | 0.426 | yes |
| fixedwide | `Fixed64<12>` | mul | 1.971 | 1.951 | 1.992 | yes |
| fixedwide | `Fixed64<12>` | div | 1.915 | 1.903 | 1.931 | yes |
| fixedwide | `Fixed64<12>` | parse | 17.633 | 17.585 | 17.662 | yes |
| fixedwide | `Fixed64<12>` | format_fixed | 13.340 | 13.260 | 13.361 | yes |
| decimal_for_cpp | `decimal<12,half_even>` | add | 0.282 | 0.281 | 0.283 | no |
| decimal_for_cpp | `decimal<12,half_even>` | mul | 40.081 | 39.901 | 40.309 | no |
| decimal_for_cpp | `decimal<12,half_even>` | div | 41.099 | 40.794 | 41.564 | no |
| decimal_for_cpp | `decimal<12,half_even>` | parse | 102.805 | 101.504 | 103.430 | no |
| decimal_for_cpp | `decimal<12,half_even>` | format_fixed | 111.808 | 111.670 | 111.881 | no |
...
| library | type | operation | median ns/op | min ns | p95 ns | checked |
|---|---|---|---:|---:|---:|---|
| boost.decimal | `decimal64_t` | add | 3.968 | 3.960 | 3.975 | no |
| boost.decimal | `decimal64_t` | mul | 3.621 | 3.570 | 3.633 | no |
| boost.decimal | `decimal64_t` | div | 9.299 | 9.285 | 9.425 | no |
| boost.decimal | `decimal64_t` | parse | 11.993 | 11.793 | 12.008 | no |
| boost.decimal | `decimal64_t` | format_fixed | 23.038 | 22.994 | 23.199 | no |
...
| library | type | operation | median ns/op | min ns | p95 ns | checked |
|---|---|---|---:|---:|---:|---|
| mpdecimal | `Decimal` | add | 13.654 | 13.483 | 13.698 | no |
| mpdecimal | `Decimal` | mul | 11.457 | 11.414 | 11.508 | no |
| mpdecimal | `Decimal` | div | 39.270 | 39.193 | 39.575 | no |
| mpdecimal | `Decimal` | parse | 23.530 | 23.479 | 23.932 | no |
| mpdecimal | `Decimal` | format_fixed | 47.743 | 47.332 | 47.787 | no |
| boost.multiprecision | `cpp_dec_float_50` | add | 12.260 | 12.219 | 12.288 | no |
| boost.multiprecision | `cpp_dec_float_50` | mul | 43.571 | 43.560 | 43.600 | no |
| boost.multiprecision | `cpp_dec_float_50` | div | 333.356 | 332.868 | 334.136 | no |
| boost.multiprecision | `cpp_dec_float_50` | parse | 59.000 | 58.729 | 59.011 | no |
| boost.multiprecision | `cpp_dec_float_50` | format_fixed | 92.122 | 91.909 | 92.281 | no |
...
| library | type | operation | median ns/op | min ns | p95 ns | checked |
|---|---|---|---:|---:|---:|---|
| cnl | `scaled_integer<int64,power<-32>>` | add | 0.286 | 0.286 | 0.288 | no |
| cnl | `scaled_integer<int64,power<-32>>` | mul | 0.516 | 0.506 | 0.517 | no |
| cnl | `scaled_integer<int64,power<-32>>` | div | 1.296 | 1.284 | 1.300 | no |
| fpm | `fixed<int64,int128,32>` | add | 0.278 | 0.277 | 0.279 | no |
| fpm | `fixed<int64,int128,32>` | mul | 1.438 | 1.428 | 1.452 | no |
| fpm | `fixed<int64,int128,32>` | div | 2.070 | 2.039 | 2.079 | no |
...
| fixedwide | `Fixed64<4>` | to_bytes_little | 0.198 | 0.198 | 0.199 | yes |
| fixedwide | `Fixed64<4>` | from_bytes_little | 0.279 | 0.277 | 0.280 | yes |
