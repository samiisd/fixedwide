...
|---|---|---|---:|---|
| cnl | `scaled_integer<int64,power<-6,10>>` | mul_unchecked | 0.330 | no |
| cnl | `scaled_integer<int64,power<-6,10>>` | div_unchecked | 1.106 | no |
| fixedwide | `Fixed64<12>` | dependent_chain_mul | 2.057 | yes |
| fixedwide | `Fixed64<12>` | div_nearest_even | 2.168 | yes |
| fixedwide | `Fixed64<12>` | mul_div_one_rounding | 2.322 | yes |
| fixedwide | `Fixed64<12>` | mul_nearest_even | 2.615 | yes |
| fixedwide | `Fixed64<12>` | parse | 11.475 | yes |
| fixedwide | `Fixed64<12>` | format | 14.892 | yes |
...
| fpm | `fixed<int64,int128,32>` | mul_nearest_unchecked | 1.365 | no |
| fpm | `fixed<int64,int128,32>` | div_nearest_unchecked | 1.946 | no |
...
| library | type | operation | median ns/op | checked |
|---|---|---|---:|---|
| boost.decimal | `decimal64_t` | mul | 3.554 | no |
| boost.decimal | `decimal64_t` | div | 8.685 | no |
| boost.decimal | `decimal64_t` | format | 12.375 | no |
| boost.decimal | `decimal64_t` | parse | 14.217 | no |
...
| library | type | operation | median ns/op | checked |
|---|---|---|---:|---|
| std | `double` | mul | 0.239 | n/a |
| std | `double` | div | 0.743 | n/a |
| std | `double` | parse | 5.332 | n/a |
| std | `double` | format | 28.590 | n/a |
...
* **parsing is faster** (11.5 ns against 14.2 ns);
* formatting is slower (14.9 ns against 12.4 ns), and that is an open item.
