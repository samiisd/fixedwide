...
#define FIXEDWIDE_INSTANTIATE_BOTH(D)                                                                                  \
    FIXEDWIDE_INSTANTIATE_128(D)                                                                                       \
    FIXEDWIDE_INSTANTIATE_64(D)

FIXEDWIDE_INSTANTIATE_BOTH(0)
FIXEDWIDE_INSTANTIATE_BOTH(1)
FIXEDWIDE_INSTANTIATE_BOTH(2)
FIXEDWIDE_INSTANTIATE_BOTH(3)
FIXEDWIDE_INSTANTIATE_BOTH(4)
FIXEDWIDE_INSTANTIATE_BOTH(5)
FIXEDWIDE_INSTANTIATE_BOTH(6)
FIXEDWIDE_INSTANTIATE_BOTH(7)
FIXEDWIDE_INSTANTIATE_BOTH(8)
FIXEDWIDE_INSTANTIATE_BOTH(9)
FIXEDWIDE_INSTANTIATE_BOTH(10)
FIXEDWIDE_INSTANTIATE_BOTH(11)
FIXEDWIDE_INSTANTIATE_BOTH(12)
FIXEDWIDE_INSTANTIATE_BOTH(13)
FIXEDWIDE_INSTANTIATE_BOTH(14)
FIXEDWIDE_INSTANTIATE_BOTH(15)
FIXEDWIDE_INSTANTIATE_BOTH(16)
FIXEDWIDE_INSTANTIATE_BOTH(17)
